...
from marvelous.client.discord.events.on_marvelous_reaction_add import on_marvelous_reaction_add
from marvelous.client.discord.events.on_super_marvelous_reaction_add import on_super_marvelous_reaction_add
from marvelous.client.discord.events.on_booing_reaction_add import on_booing_reaction_add
...
async def on_reaction_add(reaction: discord.Reaction, user: discord.User):
    ...
    if reaction_name in app_settings.marvelous.reactions:
        await on_marvelous_reaction_add(reaction, user)
    elif reaction_name in app_settings.super_marvelous.reactions:
        await on_super_marvelous_reaction_add(reaction, user)
    elif reaction_name in app_settings.booing.reactions:
        await on_booing_reaction_add(reaction, user)
